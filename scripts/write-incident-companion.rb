...
record={'schemaVersion'=>'platform.runtime-capture/v1','evidenceGrade'=>'CLOUD_RUNTIME','sourceSha256'=>"sha256:#{Digest::SHA256.file(source).hexdigest}",'incident'=>JSON.parse(File.read(incident)),'dr'=>JSON.parse(File.read(dr))}
